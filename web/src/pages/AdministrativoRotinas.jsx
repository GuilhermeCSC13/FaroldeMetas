...
const AdministrativoRotinas = () => {
  ...
  // ✅ filtro por responsável (padrão Farol de Rotinas)
  ...
  const fetchRotinasData = async () => {
    ...
    try {
      ...
      // 2) Valores mensais (inclui mes 13 e 14)
    ...
    <div className="flex flex-col h-full bg-white rounded shadow-sm overflow-hidden font-sans">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-gray-50">
        <div className="flex items-center gap-3">
          <h2 className="text-xl font-bold text-gray-800">Farol de Rotinas — Administrativo</h2>
                  ...
                  {rotinasFiltradas.map((row, idx) => (
                    <tr key={row.id || idx} className="hover:bg-gray-50 text-center">
                      ...
                      {MESES.map((mes) => {
                        ...
                        // ✅ MÉDIA 25 (mes=14): somente realizado (manual)
                        if (mes.id === 14) {
